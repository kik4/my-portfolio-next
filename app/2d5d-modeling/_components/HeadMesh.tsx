...
interface Props {
  head: HeadMeshData;
  // When true, the fill material renders with per-face normals (computed in
  // the shader via dFdx/dFdy on the world position), giving the head a
  // faceted look that exposes the underlying triangulation. False is smooth
  // shading via interpolated vertex normals.
  flatShading?: boolean;
}
