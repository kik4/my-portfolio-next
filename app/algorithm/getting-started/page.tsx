  ...
  return (
    <InPageLayout title={title} description={description}>
      <article className="prose prose-blue dark:prose-invert max-w-none">
        <h1>TypeScriptでアルゴリズムを書く</h1>

        <p>
          TypeScriptはJavaScriptに型システムを追加したプログラミング言語です。静的な型チェックにより、アルゴリズム実装時のバグを早期に発見でき、データ構造を明確に表現できます。
          その性質上、Webアプリケーションの開発に広く使われている言語です。
        </p>
        ...
        <p>
          TypeScriptを普段の業務で使っている方も多いでしょう。使い慣れた言語でアルゴリズムを学ぶことで、学習のハードルを下げ、実践的なスキルとして定着させることができます。
        </p>
        ...
        <p>
          このページのオンライン実行環境では実際の標準入力は利用できませんが、競技プログラミングなどで使われる標準入力の形式を想定し、文字列として読み込む方法で実装します。
        </p>
...
main(input.split("\\n"));`}
        ...
        <p>
          このサイトのオンライン実行環境では自由にコードを実行できますが、ブラウザやシステムの動作に影響を与える可能性がありますので注意してください。
